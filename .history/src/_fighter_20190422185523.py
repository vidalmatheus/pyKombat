...
class Fighter:
    ...
    specialLimit = [4,7]
    hitSpecialLimit = [3,1]
    specialSound = [["iceSound","IceSound2"],["ComeHere","Hit10"]]
    victoryLimit = 3
    fatalityLimit = 20
    dizzyLimit = 7
    ...
    def fight(self, time, nextFrame):
        ...
        if not self.jumping:
            ...
            # combatMoves = [["j","n","k","m","l","u","f"],["1","4","2","5","3","0","6"]] -> special move
                ...
                print("SpecialMove")
                if (self.frame_special == 0): engine.Sound(self.specialSound[fighterId][0]).play()  
            ...
            #Hhit = 19 # specialHit
                ...
                if (self.frame_special == 0): engine.Sound(self.specialSound[fighterId][1]).play()  
