...
class Fighter:
    ...
    def __init__(self, id, scenario):
        ...
        # dizzy sprite ----------------------------------
        self.spriteList.append(makeSprite('../res/Char/'+str(self.name)+'/dizzy.png', self.dizzyLimit) # Especial
        ...
        if not self.jumping:
            ...
            # dizzy
                ...
                if time > nextFrame:
                    ...
                    if (self.frame_dizzy == self.dizzyLimit - 1):
                        self.hit_step = -1
                    if (self.frame_dizzy == 0):
                        self.hit_step = 1
                        #self.hit = False
                    nextFrame += 1.2*frame_step
