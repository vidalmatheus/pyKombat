    ...
    def judge(self,scenario):
        ...
        while True:
            ...
            if(collide(player1,player2)):
                ...
                if ( ((player1.isCpunching() or player1.isCkicking() ) and not player2.isBblocking() ) or ((player2.isCpunching() or player2.isCkicking() ) and not player1.isCrouching() ) ): # falta adicionar o Bblock
