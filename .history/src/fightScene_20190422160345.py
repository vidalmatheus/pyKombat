    ...
    def judge(self,scenario):
        ...
        while True:
            ...
            if(collide(player1,player2)):
                # caso só encostem
                if ( (player1.isWalking() or player1.isJumping()) and (player2.isDancing() or player2.isCrouching()) ) or ((player2.isWalking() or player2.isJumping()) and (player1.isDancing() or player1.isCrouching()) ) or (player1.isWalking() and player2.isWalking()):
                    player1.setX(x1-15)
                    player2.setX(x2+15) 
                ...
                if ( ( (player1.isCpunching() or player1.isCkicking()) and player2.isCrouching()  )  or ( (player2.isCpunching() or player2.isCkicking()) and player1.isCrouching()  ) ):
                    if player1.isCpunching() or player1.isCkicking():                        
