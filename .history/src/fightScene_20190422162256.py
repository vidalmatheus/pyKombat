    ...
    def judge(self,scenario):
        ...
        while True:
            ...
            if(collide(player1,player2)):
                ...
                if ( player1.isAkicking() and (player2.isWalking() or player2.isDancing() or player2.isAkicking() or player2.isCrouching()) and not player2.isBblocking() ) or ( player2.isAkicking() and (player1.isWalking() or player1.isDancing() or player1.isAkicking() or player1.isCrouching() and not player2.isBblocking()) ):
