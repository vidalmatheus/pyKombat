    ...
    def judge(self,scenario):
        ...
        while True:
            ...
            if(collide(player1,player2)):
                ...
                if ( (player1.isDkicking() and (not player2.isAblocking() or not player2.isBblocking()) ) or (player1.isDkicking() and (not player2.isAblocking() or not player2.isBblocking()) ) ): 
