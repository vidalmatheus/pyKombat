    ...
    def judge(self,scenario):
        ...
        while True:
            ...
            if(collide(player1,player2)):
                ...
                if ( (player1.isApunching() or player1.isSpecialMove()) and (player2.isWalking() or player2.isDancing() or player2.isApunching()) ) or ( player2.isApunching() and (player1.isWalking() or player1.isDancing() or player1.isApunching()) ):
