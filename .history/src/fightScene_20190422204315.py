    ...
    def judge(self,scenario):
        ...
        while True:
            ...
            if(collide(player1,player2)):
                # caso só encostem
                if ( (player1.isWalking() or player1.isJumping()) and (player2.isDancing() or player2.isCrouching() or player2.isWalking()) ) or ((player2.isWalking() or player2.isJumping()) and (player1.isDancing() or player1.isCrouching() or player2.isWalking()) ) or (player1.isWalking() and player2.isWalking()) or (player1.isJumping() and player2.isJumping()) or (player2.isSpecialMove() and player1.ishitSpecial()):
                    player1.setX(x1-15)
            ...
            if ( player1.isSpecialMove() and (player2.isWalking() or player2.isDancing()) ) or ( player2.isSpecialMove() and (player1.isWalking() or player1.isDancing()) ):
                if player1.isSpecialMove():   # and collide(projetil,player2)
