    ...
    def judge(self,scenario):
        ...
        while True:
            ...
            if ( player1.isSpecialMove() and (player2.isWalking() or player2.isDancing()) ) or ( player2.isSpecialMove() and (player1.isWalking() or player1.isDancing()) ):
                if player1.isSpecialMove() and collide(player1.getProjectile().getProjectileSprite(), player2):   # and collide(projetil,player2)
...
def collide(player1,player2):
    return pygame.sprite.collide_mask(, player2.currentSprite())
